# Hybrid Search Backend Module for Backstage (`@nordnet/backstage-plugin-search-backend-module-hybrid`)
...
```typescript
import { hybridSearchEngineRegistryExtensionPoint } from '@nordnet/backstage-plugin-search-backend-module-hybrid';
